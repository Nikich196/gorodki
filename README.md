...
| Сервер | C#, ASP.NET Core 10, EF Core, PostgreSQL + PostGIS, SignalR; фоновые задачи — свой обработчик для очереди, Hangfire — для расписания ([PLAN §7.3](docs/PLAN.md#73-бэкенд)) |
...
- **Егор (одногруппник)** — сервер на C#. Его часть, карта сервера и задачи по шагам —
  **[Егор: сервер — твоя часть](docs/guides/egor-server.md)**
