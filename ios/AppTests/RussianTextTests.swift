...
struct RussianTextTests {
    ...
    /// Клан и лента (App/Social): состав клана и респекты поста.
    @Test("Участники и респекты: «1 участник», «3 участника», «12 участников», «21 респект», «5 респектов»")
    func membersAndRespects() {
        #expect(
            [1, 3, 12, 21].map(CountText.members) == ["1 участник", "3 участника", "12 участников", "21 участник"])
        #expect(
            [1, 3, 5, 21, 0].map(CountText.respects) == [
                "1 респект", "3 респекта", "5 респектов", "21 респект", "0 респектов",
            ])
    }
