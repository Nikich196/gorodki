...
struct CaptureSection: View {
    ...
    var body: some View {
        Section {
            ...
            Text(
                "Обводка 0–0,6 с · заливка от точки замыкания 0,5–1,3 с · «≈» в 0,75 с · «подтверждено» в 1,45 с "
                    + "с хаптикой · итог 1,9 с. Итог держится ярким, до L1 участок оседает после «Продолжить забег». "
