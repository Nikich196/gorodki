...
struct ScannerView: View {
    ...
    var body: some View {
        ...
        .task {
            await model.start()
            withAnimation(Motion.captureEstimate.unlessReduceMotion(reduceMotion)) { framed = true }
        }
    ...
    private var viewfinder: some View {
        ...
        return ViewfinderCorners()
            ...
            .animation(Motion.captureEstimate.unlessReduceMotion(reduceMotion), value: locked)
