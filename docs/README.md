...
| [architecture/scoring-and-seasons.md](architecture/scoring-and-seasons.md) | Очки сезона (книга очков, ступени, бонусы, дистанция, граница публичности) и смена сезона (мягкий сброс, чистая карта С0, «касались в этом сезоне») |
...
| [guides/calibration-replay.md](guides/calibration-replay.md) | Разбор записанных забегов: перепрогон точек через детектор петли и контур сервера с другими R, `A_min`, `R_min` — калибровка на полевом тесте №1 |
