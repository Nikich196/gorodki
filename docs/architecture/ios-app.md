...
- **Проверки.** GameCore (`LandTests`, `MomentTextTests`, Linux): отношение, уровень, щит и осада, истёкшие зоны,
  ...
  окно и подгрузка, фикстура, слой не зависит от окраски. Снимки 24–29 (`ScreenSnapshotTests`): 28 проверяет цвет заливки
  соперника после «Отношений», 29 — смену слоя нажатием.
