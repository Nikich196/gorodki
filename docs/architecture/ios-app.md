...
- **Статистика «Исследования»** (экран 15): герой — «% Бреста» (когда сервер отдаёт поля E9) или гектары и клетки
  с «% Бреста — появится позже»; по периодам (всё время, текущий сезон «· идёт»), районы (доли с полосами цвета
