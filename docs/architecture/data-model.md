...
| `score_events` | Книга очков сезона ([очки и сезоны](scoring-and-seasons.md)) | Строка на захват (в его транзакции) и на дистанцию забега (с визитами); сезон и игровые сутки — по времени петли; `visible_at` — другим видно только с границы публичности; одно начисление на захват и на забег — уникальные индексы; откат захвата стирает его строку, удаление аккаунта — каскадом |
