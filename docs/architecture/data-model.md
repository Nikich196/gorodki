...
| `parcels` | Куски земли | Один простой многоугольник внутри одного тайла 1×1 км; **база сама отвергает неправильную геометрию** (`st_isvalid`); GiST-индекс; кто и когда снимал уровни (`loss_window_since`, `loss_attackers`) и пометка «спорная» после большой петли (`contested_until`, §3.3) — часть состояния куска |
