...
`UPDATE app.parcels`, `ExecuteUpdate` по `Parcels`, `Parcels.Update/Attach` и присваивание полям куска вне этих двух файлов.
...
строки точного отката (`capture_journal_parcels`) — 1–2 часа (`max(1 ч, 2 × (задержка + шаг раскрытия))`, чистка раз в
час; строка ~230 Б плюс ~5 Б на вершину удалённого контура: обычно 1–2 МБ, в худшем случае ~40 МБ), туман — сжатые биты,
