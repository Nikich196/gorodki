...
(нет места) забег не закрывает: точки снова принимаются, «Финиш» можно повторить; предупреждение `storageFailed`
гаснет только после записанной точки. Истёкший вход запись не останавливает — очередь дождётся входа.
