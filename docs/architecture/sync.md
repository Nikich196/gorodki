...
Не сделано: экран забега (дизайн — Никита), замер запаздывания датчиков (S1).
Проверить на телефоне: забег в кармане 30 минут, выгрузка приложения из фона и
продолжение, «Финиш» без сети.
