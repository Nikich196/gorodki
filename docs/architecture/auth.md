...
- Фоновый обработчик при ближайшем часовом проходе стирает аккаунт одной транзакцией под блокировкой игрока: землю
...
- Выгрузка данных («мои данные», тот же пункт закона) — отдельным PR.
