...
- Фоновый обработчик при ближайшем часовом проходе — но не раньше чем через 20 минут после запроса и после последнего
  захвата игрока (иначе стёртая земля проступила бы контуром недавней петли, ещё скрытой от остальных) — стирает аккаунт
