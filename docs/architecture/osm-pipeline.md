...
> Арены решены 25.09 по рекомендациям Claude с разрешения Никиты: [вопросы по OSM](../decisions/osm-questions.md),
> строки «Решено 25.09», и [PLAN.md](../PLAN.md) §3.3, §3.6, §3.10. Здесь они — именованные параметры; чего в решениях
> нет (ширина погранполосы), остаётся пустым.
