...
6. Захваты старше недели (или применённые до журнала) не откатываются — считаются в итоге как «без журнала».
7. Свои касания нарушителя (визиты, повторные петли по отнятой земле) «тронутой» её **не делают**: иначе, побегав по
   украденному, он бы его «отмыл». Касание чужого — захват, визит соклановца, смена сезона — по-прежнему защищает землю.

Открытый вопрос правил (решает Никита): не засчитывать ли жертве угасание за время, пока земля была отнята.
Земля, которую после захвата нарушителя освежил соклановец, сейчас считается «тронутой» — вопрос встанет с кланами.
...
- **Когда**: один раз за забег, в том же фоновом обработчике, что и захваты (после них, перед туманом), когда забег
  завершён и все точки на месте — то же условие, что у тумана. Отметка — `runs.visits_processed_at`, итог — `visited_parcels`.
...
- Приватных зон ещё нет — появятся вместе с ними (§3.16).
...
Снятие заморозки и бан (слой 5), outbox и SignalR, маски OSM, кланы, ослабление большой петли, защита от мультиаккаунтов,
приватные зоны, чистка сырых точек через 14 дней.
