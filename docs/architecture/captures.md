...
- Перенос идёт **по граням следа**: визит, засчитанный на остатке куска вне следа, с возвращённой землёй не сливается.
  ...
  неточность у остатка на один визит (угасание и, может быть, +1 уровень), для публичной проекции — шов по линии
  скрытой петли ([territory-map.md](territory-map.md)).
...
- **Пока чужой захват скрыт**: визиты засчитываются, когда публичен конец забега, а захват той же земли, применённый в
  ...
  прежнюю землю: взятое, уровень −1 и осада до раскрытия не видны. Но **шов по линии петли** у жертвы (и у автора на
  освежённой земле) остаётся почти всегда: у частей куска разное время визита и свой порог 50 м. Закроет его точный
  откат по исходным кускам ([territory-map.md](territory-map.md)).
