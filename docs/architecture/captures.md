...
flowchart TD
    ...
    B1 --> OK[applied: разница кусков, tile_versions, applied_seq]
```
...
Журнал прежних кусков для отката (7 дней), outbox и SignalR, маски OSM, кланы, ослабление большой петли, защита от мультиаккаунтов,
