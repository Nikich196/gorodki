...
/// на прежнюю землю так, как легли бы на неё в мире без захвата. Перенос идёт по граням следа захвата, поэтому шов по
/// линии петли остаётся, если части куска получили разное время визита (docs/architecture/territory-map.md). В публичную
/// проекцию такие визиты не попадают: сервер не засчитывает визиты на землю захвата, пока он скрыт, — там перенос лишь
/// страховка; у отката нарушителя шов — неточность остатка на один визит.
/// </remarks>
