...
/// и осадой, шов по линии петли. Визиты публичны (засчитываются после публичной задержки), поэтому в проекции они
/// должны остаться — но лечь на прежнюю землю так, как легли бы на неё в мире без захвата.
/// </remarks>
public static class VisitReplay
{
    ...
    /// откат оставит такую землю как есть — как раньше.
    /// </remarks>
