...
public sealed class RunEntity
{
    ...
    /// <summary>
    /// Визиты забега не пробуются раньше этого момента: пауза после ошибки или раскрытие скрытого захвата земли игрока
    /// в тайлах забега (до него визиты выдали бы захват).
    /// </summary>
