...
/// (граница публичности, §3.16). Безопасно её считает <c>TerritoryReader.VisibleOwnedAreaAsync</c> (та же проекция, что у
/// карты); поле — отдельным изменением контракта после задачи #116.
/// </remarks>
