...
public sealed class RunsTests(DatabaseFixture database)
{
    ...
    private static StartRunRequest NewStart(ApiFactory api, TimeSpan? startedAgo = null, long clockSkewMs = 0, RunSource source = RunSource.Live)
    {
    ...
    private static UploadChunkRequest ChunkRequest(
